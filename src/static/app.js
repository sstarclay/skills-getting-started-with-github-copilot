    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsMarkup = details.participants.length
          ? `<div class="participants"><p class="participants-title">Participants:</p><ul class="participants-list">${details.participants
              .map(
                (participant) => `
          ...
          : `<div class="participants"><p class="participants-title">Participants:</p><p class="no-participants">No participants yet.</p></div>`;
